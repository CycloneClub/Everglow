...
| bio-death-jade-lake-verdant-rods | 3 | Death Jade Lake | 叶飞棍 | Verdant Rods | `` | `Sources/Modules/Yggdrasil/KelpCurtain/NPCs/VerdantRods.png` | true | false | false | unchecked | texture present in repository; runtime and localization verification outstanding (D-20/D-21) | false |
| bio-death-jade-lake-river-slug | 3 | Death Jade Lake | 水蛞蝓 | River Slug | `Everglow.Yggdrasil.KelpCurtain.NPCs.RiverSlug` | `Sources/Modules/Yggdrasil/KelpCurtain/NPCs/RiverSlug.png` | true | true | true | unchecked | pre-existing accepted implementation (D-23): class untouched by Phase 3; its SpawnChance relies on SpawnModBiomes for subworld isolation and its HitEffect dust is not Main.dedServ-guarded | false |
...
| bio-spiny-moss-court-giant-tree-man | 3 | Spiny Moss Court | 巨树人 | Giant Tree Man | `` | `Sources/Modules/Yggdrasil/KelpCurtain/NPCs/GiantDandelion.png` | true | false | false | unchecked | texture present in repository; runtime and localization verification outstanding (D-20/D-21) | false |
...
| bio-valley-of-lush-and-moist-mossy-thorn-turtle | 3 | Valley of Lush and Moist | 荆棘苔龟（Thorn Mossy Tortoise） | Thorn Mossy Tortoise | `Everglow.Yggdrasil.KelpCurtain.NPCs.MossyThornTurtle` | `Sources/Modules/Yggdrasil/KelpCurtain/NPCs/MossyThornTurtle.png` | true | false | true | unchecked | texture present in repository; runtime and localization verification outstanding (D-20/D-21) | false |
...
| bio-valley-of-lush-and-moist-guppy-conch | 3 | Valley of Lush and Moist | 格普螺 | Guppy Conch | `` | `Sources/Modules/Yggdrasil/KelpCurtain/NPCs/GuppyConch.png` | true | false | false | unchecked | texture present in repository; runtime and localization verification outstanding (D-20/D-21) | false |
