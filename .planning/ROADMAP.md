...
- [ ] 02-02-PLAN.md — Biology-design drop weapons: boulder catapult projectile chain, tendon greatbow + arrow, restriction device, reeking bait (ITEM-01, ITEM-03)

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 02-03-PLAN.md — 灵蛇玉卵 use item + the six art-pending shells group A (ITEM-03, ITEM-04)

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 02-04-PLAN.md — The four system-dependent shells + the two remaining art-pending shells; closes item coverage at 21/21 (ITEM-02, ITEM-03)
