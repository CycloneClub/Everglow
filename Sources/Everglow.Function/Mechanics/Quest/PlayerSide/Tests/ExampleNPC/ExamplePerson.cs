...
namespace Everglow.Commons.Mechanics.Quest.PlayerSide.Tests.ExampleNPC;
...
public class ExamplePerson : ModNPC
{
	...
	{ // Requirements for the town NPC to spawn.
		foreach (var player in Main.ActivePlayers)
		{
			...
			if (player.inventory.Any(item => item.type == ItemID.DirtBlock || item.type == ItemID.DirtBlock))
			{
				return true;
			}
		}
	...
	{
		npcLoot.Add(ItemDropRule.Common(ItemID.DirtBlock));
	}
