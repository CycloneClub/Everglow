...
/// <summary>
/// 桃枝护符 - identity-only accessory shell (D-18). The design row carries no
/// 伤害 / 价格 / 稀有度 / 效果 cells and its 描述 cell reads 饰品 (accessory), which selects the
/// Accessories category. Approved artwork is absent from the repository.
/// </summary>
