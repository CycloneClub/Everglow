...
{
	public class FurnaceScoreMilestoneRewardUI_VerticalScrollbar : UIVerticalScrollbar
	{
		public override float Scale => 1f;

		public override float TopMax => -7f * Scale;

		public override float TopMin => -7f * Scale;
		...
		public FurnaceScoreMilestoneRewardUI_VerticalScrollbar()
		{
		...
		{
			var tex = ModAsset.FurnaceScoreMilestoneRewardUI_Scrollbar.Value;
			var trackScale = new Vector2(1, Info.TotalHitBox.Height / (float)tex.Height);
			sb.Draw(tex, Info.TotalHitBox.Top() + new Vector2(0, 0), new Rectangle(0, 0, 4, 3), Color.White, 0, new Vector2(2, 3), 2, SpriteEffects.None, 0);
			sb.Draw(tex, new Rectangle(Info.TotalHitBox.Center.X - 4, Info.TotalHitBox.Top + 4, 8, Info.TotalHitBox.Height - 10), new Rectangle(0, 4, 4, 16), Color.White);
			sb.Draw(tex, Info.TotalHitBox.Top() + new Vector2(0, Info.TotalHitBox.Height), new Rectangle(0, 21, 4, 3), Color.White, 0, new Vector2(2, 0), 2, SpriteEffects.None, 0);
			var thumbFrame = new Rectangle(7, 0, 6, 16);
			if (_mouseOver || _isMouseDown)
			{
				thumbFrame = new Rectangle(21, 0, 6, 16);
			}
			sb.Draw(tex, _scrollbarThumb.Info.TotalHitBox.Center(), thumbFrame, Color.White, 0, thumbFrame.Size() * 0.5f, 2f, SpriteEffects.None, 0);
		}
	}
}
